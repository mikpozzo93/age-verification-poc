...
Furthermore, to prevent tracking or profiling, the IT-Wallet's organizational structure, defined by applicable legislation, enforces: 1) **logical separation** of personal data from other services provided by the Wallet Provider; and 2) the **non-monitoring of credentials after issuance** by the Issuer.
